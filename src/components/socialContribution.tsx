...
function SocialContribution() {
  ...
  const drawWebsites = () => {
    let socialContribution2 = <div className="singleProjectContainer">
      <div className="singleWebsiteCard">
        <a className="tempa" href="https://needleworm.github.io/dream2022" target="_blank"  rel="noreferrer">
         <img className="websiteImage" src="https://cdn.jsdelivr.net/gh/needleworm/needleworm.github.io@latest@latest/src/images/socialContributions/dream2022.png" alt="projectimage"/>
        </a>
    ...
    let socialContribution1 = <div className="singleProjectContainer">
      <div className="singleWebsiteCard">
        <img className="websiteImage" src="https://cdn.jsdelivr.net/gh/needleworm/needleworm.github.io@latest@latest/src/images/socialContributions/busking.gif" alt="projectimage"/>
        <div className="projectText">
