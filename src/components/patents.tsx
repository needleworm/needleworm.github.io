...
function Patents() {
  ...
  let patent15 = <div className="singleProjectContainer">
    ...
    <div className="singleWebsiteCard">
      ...
      <div className="projectText">
        ...
        <div className="projectIcons">
          ...
          <div className="gitIcons">
            <a href="https://cdn.jsdelivr.net/gh/needleworm/needleworm.github.io/src/patentPdf/25.pdf" target="_blank"  rel="noreferrer" download>
              <i className="fas fa-file-pdf"></i>
            </a>
            &nbsp;&nbsp;&nbsp;
      ...
      <div className="singleWebsiteCard">
        ...
        <div className="projectText">
          ...
          <div className="projectIcons">
            ...
            <div className="gitIcons">
              <a href="https://cdn.jsdelivr.net/gh/needleworm/needleworm.github.io/src/patentPdf/27.pdf" target="_blank"  rel="noreferrer" download>
                <i className="fas fa-file-pdf"></i>
              </a>
              &nbsp;&nbsp;&nbsp;
    ...
    let patent28 = <div className="singleProjectContainer">
      <div className="singleWebsiteCard">
        <img className="websiteImage" src="https://cdn.jsdelivr.net/gh/needleworm/needleworm.github.io/src/images/patents/28.png" alt="projectimage"/>
        <div className="projectText">
          <h5>비전인식을 활용한 의료용 헴프의 삽목 자동화 장치 및 방법</h5><br/>
          <div className="bookDescription">
            <strong>등록번호</strong> &nbsp;&nbsp;&nbsp;10-2500388
            <div className="patentInfo">
              <div><strong>출원일</strong> &nbsp;&nbsp;&nbsp;2022.09.08</div>
          ...
          <div className="projectIcons">
            ...
            <div className="gitIcons">
              <a href="https://cdn.jsdelivr.net/gh/needleworm/needleworm.github.io/src/patentPdf/28.pdf" target="_blank"  rel="noreferrer" download>
                <i className="fas fa-file-pdf"></i>
              </a>
              &nbsp;&nbsp;&nbsp;
              <a href="https://doi.org/10.8080/1020220114177" target="_blank"  rel="noreferrer">
                <i className="fas fa-external-link-alt"></i>
              </a>
            </div>
          </div>
    ...
    let patent30 = <div className="singleProjectContainer">
      <div className="singleWebsiteCard">
        <img className="websiteImage" src="https://cdn.jsdelivr.net/gh/needleworm/needleworm.github.io/src/images/patents/30.jpg" alt="projectimage"/>
        <div className="projectText">
          <h5>3차원 영상 재건 알고리즘을 활용한 식물공장 디지털 트윈 인터페이스 제공 장치 및 방법</h5><br/>
          <div className="bookDescription">
            <strong>등록번호</strong> &nbsp;&nbsp;&nbsp;10-2538747
            <div className="patentInfo">
              <div><strong>출원일</strong> &nbsp;&nbsp;&nbsp;2022.11.28</div>
          ...
          <div className="projectIcons">
            ...
            <div className="gitIcons">
              <a href="https://cdn.jsdelivr.net/gh/needleworm/needleworm.github.io/src/patentPdf/30.pdf" target="_blank"  rel="noreferrer" download>
                <i className="fas fa-file-pdf"></i>
              </a>
              &nbsp;&nbsp;&nbsp;
              <a href="https://doi.org/10.8080/1020220161821" target="_blank"  rel="noreferrer">
                <i className="fas fa-external-link-alt"></i>
              </a>
            </div>
          </div>
