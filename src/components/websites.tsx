  ...
  const drawWebsites = () => {
    ...
    let blog = <div className="singleProjectContainer">
      <div className="singleWebsiteCard">
        <a className="tempa" href="https://needleworm.github.io" target="_blank"  rel="noreferrer">
         <img className="websiteImage" src="https://cdn.jsdelivr.net/gh/needleworm/needleworm.github.io@latest@latest/src/images/websites/blog.gif" alt="projectimage"/>
        </a>
    ...
    let ai = <div className="singleProjectContainer">
      <div className="singleWebsiteCard">
        ...
        <img className="websiteImage" src="https://cdn.jsdelivr.net/gh/needleworm/needleworm.github.io@latest@latest/src/images/websites/ai.gif" alt="projectimage"/>
        </a>
        <div className="projectText">
    ...
    let rpa = <div className="singleProjectContainer">
      <div className="singleWebsiteCard">
        ...
        <img className="websiteImage" src="https://cdn.jsdelivr.net/gh/needleworm/needleworm.github.io@latest@latest/src/images/websites/rpa.gif" alt="projectimage"/>
        </a>
        <div className="projectText">
    ...
    let financebook = <div className="singleProjectContainer">
      <div className="singleWebsiteCard">
        ...
        <img className="websiteImage" src="https://cdn.jsdelivr.net/gh/needleworm/needleworm.github.io@latest@latest/src/images/websites/financebook.gif" alt="projectimage"/>
        </a>
        <div className="projectText">
    ...
    let dataset = <div className="singleProjectContainer">
      <div className="singleWebsiteCard">
        ...
        <img className="websiteImage" src="https://cdn.jsdelivr.net/gh/needleworm/needleworm.github.io@latest@latest/src/images/websites/dataset.gif" alt="projectimage"/>
        </a>
        <div className="projectText">
    ...
    let b101 = <div className="singleProjectContainer">
      <div className="singleWebsiteCard">
        ...
        <img className="websiteImage" src="https://cdn.jsdelivr.net/gh/needleworm/needleworm.github.io@latest@latest/src/images/websites/101.gif" alt="projectimage"/>
        </a>
        <div className="projectText">
    ...
    let frontend = <div className="singleProjectContainer">
      <div className="singleWebsiteCard">
        ...
        <img className="websiteImage" src="https://cdn.jsdelivr.net/gh/needleworm/needleworm.github.io@latest@latest/src/images/websites/frontend.gif" alt="projectimage"/>
        </a>
        <div className="projectText">
    ...
    let moneyauto = <div className="singleProjectContainer">
      <div className="singleWebsiteCard">
        ...
        <img className="websiteImage" src="https://cdn.jsdelivr.net/gh/needleworm/needleworm.github.io@latest@latest/src/images/websites/moneyauto.gif" alt="projectimage"/>
        </a>
        <div className="projectText">
    ...
    let sangsangfarm = <div className="singleProjectContainer">
      <div className="singleWebsiteCard">
        <a className="tempa" href="https://www.sangsang.farm" target="_blank"  rel="noreferrer">
         <img className="websiteImage" src="https://cdn.jsdelivr.net/gh/needleworm/needleworm.github.io@latest@latest/src/images/websites/sangsangfarm.gif" alt="projectimage"/>
        </a>
        <div className="projectText">
    ...
    let business = <div className="singleProjectContainer">
      <div className="singleWebsiteCard">
        ...
        <img className="websiteImage" src="https://cdn.jsdelivr.net/gh/needleworm/needleworm.github.io@latest@latest/src/images/websites/business.gif" alt="projectimage"/>
        </a>
        <div className="projectText">
    ...
    let price = <div className="singleProjectContainer">
      <div className="singleWebsiteCard">
        ...
        <img className="websiteImage" src="https://cdn.jsdelivr.net/gh/needleworm/needleworm.github.io@latest@latest/src/images/websites/price.gif" alt="projectimage"/>
        </a>
        <div className="projectText">
    ...
    let sstb2 = <div className="singleProjectContainer">
      <div className="singleWebsiteCard">
        <a className="tempa" href="https://www.sangsang.farm" target="_blank"  rel="noreferrer">
        <img className="websiteImage" src="https://cdn.jsdelivr.net/gh/needleworm/needleworm.github.io@latest@latest/src/images/websites/sstb2.gif" alt="projectimage"/>
        </a>
        <div className="projectText">
          <a className="text-center textMarginBottom" href="https://www.sangsang.farm" target="_blank"  rel="noreferrer">
            <h5>https://www.sangsang.farm</h5><br/>
    ...
    let tech3 = <div className="singleProjectContainer">
      <div className="singleWebsiteCard">
        ...
        <img className="websiteImage" src="https://cdn.jsdelivr.net/gh/needleworm/needleworm.github.io@latest@latest/src/images/websites/tech3.png" alt="projectimage"/>
        </a>
        <div className="projectText">
    ...
    let dev = <div className="singleProjectContainer">
      <div className="singleWebsiteCard">
        ...
        <img className="websiteImage" src="https://cdn.jsdelivr.net/gh/needleworm/needleworm.github.io@latest@latest/src/images/websites/dev.png" alt="projectimage"/>
        </a>
        <div className="projectText">
